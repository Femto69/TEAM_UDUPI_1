...
Original file is located at
    https://colab.research.google.com/drive/1pDFAhXhoI5bFHee80SgZlh0KzvDNrL48
"""
...
data1 = pd.read_csv('/content/delhi_aqi.csv.zip')
data3 = pd.read_csv('/content/weatherdata.csv')
...
# Assuming season_creation is a predefined function that returns the season based on the month
